...
win32 {
    ...
    macx {
        ...
        LIBS += -L$$PWD/macosxprecompiled -lpdfium -lfdrm -lformfiller -lfpdfapi -lfpdfdoc -lfpdftext -lfxcodec -lfxcrt -lfxge -lfxjs -lpwl -lfx_agg -lbigint -lfx_freetype -lfx_lcms2 -lfx_libopenjpeg -licuuc -ljpeg-lyasm_utils -lchrome_zlib -lzlib_x86_simd -lsimd -lsimd_asm
        INCLUDEPATH += $$PWD/prebuilt-headers/
    } else {
